...
async function createArticle (author, payload) {
  const article = new Article(Object.assign(payload, { author }))
...
async function addComment (article, author, commentPayload) {
  const comment = new Comment(Object.assign({ author, article }, commentPayload))
