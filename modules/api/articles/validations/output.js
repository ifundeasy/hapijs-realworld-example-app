...
const ArticleJSON = Joi.object().keys({
  ...
  tagList: Joi.array().description('The article related tags'),
...
const CommentOnPostOutputValidationsConfig = _.merge({}, ErrorsOnPostOutputValidations, {
  status: {
...
module.exports = {
  ...
  CommentOnPostOutputValidationsConfig,
