...
const ArticleCreatePayload = Joi.object().keys({
  article: Joi.object().keys({
    ...
    description: Joi.string()
      ...
      .example('Learn how to write a REST Api with HapiJS'),
    body: Joi.string()
      .required()
      .description('the article body')
      .example(
        'Proident do incididunt minim do nostrud qui qui enim enim consequat et consectetur incididunt officia. Magna tempor nostrud anim anim commodo non id amet cupidatat pariatur nulla. Cupidatat officia officia incididunt do deserunt laboris pariatur et minim non et ea Lorem ea. Ipsum cillum ullamco sunt dolor exercitation ipsum nostrud amet aute deserunt. Ullamco ex sunt laborum laboris nisi nisi proident do est laboris Lorem magna.'
      ),
    tagList: Joi.array().description('the article tags').optional().example(['HapiJS', 'Node', 'REST', 'API'])
  })
})
...
const CommentCreatePayloadValidations = _.merge({}, ArticleParamsValidations, {
